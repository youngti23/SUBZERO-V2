...
let handler = async (_0x5028d9, {
  ...
  if (_0x5871d8.length >= 0x1) {
    ...
    _0x5028d9.reply("Let's see what image I can dream up from \"" + _0x27ce5a + "\"...");
  } else if (_0x5028d9.quoted && _0x5028d9.quoted.text) {
    _0x27ce5a = _0x5028d9.quoted.text;
    _0x5028d9.reply("Aha! Using your quoted text, \"" + _0x27ce5a + "\", let's generate an image...");
  } else {
    throw "Oops! I need an input text. Try something like this:\n.midjourney man kissing";
  }
  try {
    _0x5028d9.reply("Brewing up some AI magic... 🧙‍♂️");
    ...
    if (_0x300556.length > 0x0) {
      ...
      _0x47aad9.sendFile(_0x5028d9.chat, _0x413a91, _0x27ce5a, "*[Ta-da! Here's your result:]*\n\"" + _0x27ce5a + "\"", _0x5028d9);
    } else {
